...
Deploy your entire Flask application to Kubernetes with a single PowerShell script. This automation script handles cluster verification, image pulling, manifest deployment, and port forwarding—all the manual steps now happen automatically with one command.
...
Think of it as your one-click deployment button—everything from cluster setup to app access in a single script.

## 📝 The Deployment Script

**View the complete deployment script here:**  
👉 [deploy.ps1](https://github.com/codewithmonil/Devops-Magic/blob/main/deploy.ps1)
...
**Made with ❤️ for lazy people who want deployment automation that just works**
